...
func TestInvokeHandlerinvalidRequestReturnFailure(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var f tFunc = func(resource MockCustomResource) (*ProgressEvent, error) {
...
func TestCustomHandlerProcessInvocationsynchronousReturnsSuccess(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var f tFunc = func(resource MockCustomResource) (*ProgressEvent, error) {
				return &ProgressEvent{OperationStatus: Complete, ResourceModel: resource}, nil
			}
...
func TestCustomHandlerProcessInvocationNoLambdaContextReturnsFailed(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var f tFunc = func(resource MockCustomResource) (*ProgressEvent, error) {
				return &ProgressEvent{OperationStatus: InProgress, ResourceModel: resource, CallbackDelaySeconds: 120}, nil
			}
...
func TestCustomHandlerProcessInvocationsynchronousReturnsFailure(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var f tFunc = func(resource MockCustomResource) (*ProgressEvent, error) {
				return &ProgressEvent{OperationStatus: FAILED, ResourceModel: resource, HandlerErrorCode: InternalFailure, Message: "Custom Fault"}, nil
			}
