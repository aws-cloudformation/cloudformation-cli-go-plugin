...
func (rd *requestData) UnmarshalJSON(b []byte) error {
	...
	rd.ProviderCredentials = credentials.NewProvider(
		d.ProviderCredentials["accessKeyId"],
		d.ProviderCredentials["secretAccessKey"],
		d.ProviderCredentials["sessionToken"],
	)
...
func (rd *requestData) MarshalJSON() ([]byte, error) {
	...
	provider, _ := rd.ProviderCredentials.Retrieve()
	...
	d.ProviderCredentials = map[string]string{
